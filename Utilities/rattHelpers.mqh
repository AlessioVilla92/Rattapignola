//+------------------------------------------------------------------+
//|                                              rattHelpers.mqh     |
//|           Rattapignola EA v1.6.1 — Helper Functions              |
//|                                                                  |
...
{
   string filename = "Rattapignola_" + _Symbol + "_" +
...
//| (forward declaration — implemented in rattCycleManager.mqh)      |
//+------------------------------------------------------------------+
