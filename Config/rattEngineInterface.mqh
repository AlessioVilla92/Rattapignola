//+------------------------------------------------------------------+
//|                                      rattEngineInterface.mqh     |
//|           Rattapignola EA v1.6.1 — Engine Contract               |
//|                                                                  |
//|  CONTRATTO STABILE — QUESTO FILE NON CAMBIA MAI                  |
//|                                                                  |
//|  Per swappare engine (UTBot -> ATR Bands -> LuxAlgo):             |
//|    1. Crea Engine/rattNewEngine.mqh (+ sottomoduli)              |
//|    2. Implementa le 3 funzioni del contratto                     |
//|    3. Cambia le righe #include Engine/ in Rattapignola.mq5       |
