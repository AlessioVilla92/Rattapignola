//+------------------------------------------------------------------+
//|                                        rattOrderManager.mqh      |
//|           Rattapignola EA v1.6.1 — Order Manager                 |
//|                                                                  |
...
ulong OrderPlace(const EngineSignal &sig, double lots, int cycleID)
{
   ...
   string comment = StringFormat("RATT_%s_#%d", dirStr, cycleID);
...
//|                                                                  |
//| Usato da UpdatePending() quando il trail si muove e              |
