//+------------------------------------------------------------------+
//|                                    rattRecoveryManager.mqh       |
//|           Rattapignola EA v1.7.2 — Recovery Manager              |
//|                                                                  |
...
//|                                                                  |
//| Il comment di ogni ordine/posizione Rattapignola segue il formato:|
//|   Soup: "RATT_BUY_#12" / "RATT_SELL_#3"                         |
//|   HS:   "RATT_HS_SELL_#12" / "RATT_HS_BUY_#3"                   |
...
{
   if(StringFind(comment, "RATT_BUY") >= 0)  return +1;
   if(StringFind(comment, "RATT_SELL") >= 0) return -1;
   return 0;
}
...
void AttemptRecovery()
{
   ...
   {
      AdLogI(LOG_CAT_RECOVERY, "No Rattapignola orders found — clean start");
   }
}
